# act_thread3.py + 파라미터 조작(Dynamic Reconfigure)
import rclpy
...
class DistSrvr4(Node):
    def __init__(self):
        ...
        # 파라미터를 Dynamic Reconfigure하기 위한 블록
        param_desc = ParameterDescriptor(
            ...
            floating_point_range = [FloatingPointRange(
                ...
                to_value=1.0, 
                step=0.01
            )] # 슬라이딩바 눈금 범위: 0.0 ~ 1.0, 0.1씩
        )

        # 파라미터 연습용 블록
        self.declare_parameter('quantile_time', 0.75, param_desc)
